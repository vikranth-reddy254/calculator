...
const titlebox = document.getElementsByClassName("titlebox");
...
const CscoreValue = document.getElementById("Cscore-value");
...
let Cscore = Number(localStorage.getItem("Cscore")) ;
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      if (winner === "player") {
        ...
        CscoreValue.innerHTML = Cscore += 1;
